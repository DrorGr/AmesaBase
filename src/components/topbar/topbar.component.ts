import { Component, inject, ViewEncapsulation, OnInit, effect } from '@angular/core';
        ...
        @if (isMobile() && isMobileMenuOpen) {
          <div class="absolute top-full left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-4 animate-fadeIn shadow-lg z-50">
            ...
            <div class="space-y-2">
              ...
              <a href="#" class="block px-8 py-6 text-3xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-blue-600 dark:hover:text-blue-400 font-bold transition-colors duration-200 min-h-[72px] mobile-nav-button">
                {{ translate('nav.winners') }}
              </a>
            </div>
          </div>
